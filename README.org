...
Newer versions should work (otherwise feel free to open an issue).
 ...
 - [[https://drive5.com/muscle/downloads_v3.htm][muscle]] (v3.8.1551) - Edgar et al, 2004. MUSCLE: multiple sequence alignment with high accuracy and high throughput. Nucleic Acids Res. 32, 1792–1797. NOTE: please use 3.8. Version 5+ is not supported
