...
*** Test perl code
#+BEGIN_SRC sh
# Make sure you have all the external tools installed (see above)
...
*** Build java code and jar
Run src_sh{ant} in the bcgTreeGUI folder to compile src to bin and build the bcgTree.jar file.
